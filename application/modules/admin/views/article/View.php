		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<a  class="btn btn-success" href="<?php echo base_url('admin/Article/viewDraft')?>">Draft</a>
						<a  class="btn btn-danger" href="<?php echo base_url('admin/Article/viewDeleted')?>">Deleted</a>
