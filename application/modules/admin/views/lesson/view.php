							...
							<div class="product-status-wrap drp-lst">
								<table class="table table-striped table-bordered " id="table" data-toggle="table"
									...
									<tr>
										...
										<td> <a data-target="<?php echo '#'.$row['lesson_id']; ?>" class="text-center tip"
												data-toggle="modal" data-original-title="Edit"><i
													class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
											<a title="Trash" class="pd-setting-ed"
												onclick="delete_detail(<?php echo $row['lesson_id'] ;?>)"><i class="fa fa-trash-o"
													aria-hidden="true"></i></a></td>
									</tr>

									<div id="<?php echo $row['lesson_id'] ; ?>"
										class="modal  default-popup-PrimaryModal fade" role="dialog">
										<div class="modal-dialog" role="document ">
											<div class="modal-content">
												<form class="form-horizontal" method="post"
													action="<?php echo base_url('admin/Lesson/Update/').$row['lesson_id'] ?>"
